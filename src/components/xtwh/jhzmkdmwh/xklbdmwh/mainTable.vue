      ...
      deleteData(dm){
            ...
            this.axios.get('jwc/DmXklb/delete?xklbdm='+dm)
                ...
                .catch(function (error) {
                    console.log(error);
                    _this.$message({ message: '删除学科类别失败', type: 'error' });
                });
      }, 
      getData(){
        var _this=this;
        ...
        this.axios.get('jwc/DmXklb/getAll')
            .then(function (response) {
                ...
                _this.$notify({title:"获取学科类别", message:"获取学科类别成功", type:"success"});
                _this.loading = false;
            })
            .catch(function (error) {
                console.log(error);
                _this.$notify({title:"获取学科类别", message:"获取学科类别失败", type:"success"});
                _this.loading = false;
            });
      }
    }
